...
import { ArrowDownCircle, BookCopy, MoreHorizontal, PlusCircle, Search } from "lucide-react";
        ...
        <div className="grid gap-6 md:grid-cols-2">
            <Card>
                ...
                <CardContent>
                    ...
                    Total dari semua pemasukan yang tercatat.
                    </p>
                </CardContent>
            </Card>
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">{pemasukanList.length}</div>
                    <p className="text-xs text-muted-foreground">
                        Total transaksi pemasukan yang tercatat.
                    </p>
                </CardContent>
            </Card>
        </div>
